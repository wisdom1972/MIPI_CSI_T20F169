...
module edb_top (
    ...
    output bscan_TDO,
    input  MipiTx_clk,
    input  [23:0] MipiTx_ParamTxVertSyncLength_Cycle,
    input  [15:0] MipiTx_ParamTxHoriSyncLength_Cycle,
    input  [15:0] MipiTx_paramTxDataValidLength_Cycle,
    input  [19:0] MipiTx_paramTxVertBlankLength_Cycle,
    input  [15:0] MipiTx_paramTxHoriBlankLength_Cycle,
    input  [15:0] MipiTx_RealTxHoriPixelNumber,
    output [7:0] MipiTx_ConfigTxFrameRate,
    output [15:0] MipiTx_ConfigTxVertPixelNumber,
    output [15:0] MipiTx_ConfigTxHoriPixelNumber,
    output [11:0] MipiTx_ConfigTxVBlankTime_us,
    output [7:0] MipiTx_ConfigTxHBlankTime_us,
    output [2:0] MipiTx_configTxLanesNumber,
    output [5:0] MipiTx_ConfigPixelDataType,
    output [3:0] MipiTx_ConfigTxVCEnable,
    output [0:0] MipiTx_ControlTxDPHYReset,
    output [0:0] MipiTx_ControlTxCSIReset,
    output [0:0] MipiTx_ControlTxDisable,
    output [0:0] MipiTx_ConfigTxFramerMode,
    input  MipiRx_clk,
    input  [7:0] MipiRx_VidioRxFrameRate,
    input  [15:0] MipiRx_VidioRxVertPixeNumber,
    input  [15:0] MipiRx_VidioRxHoriPixeNumber,
    input  [19:0] MipiRx_VidioRxVBlankTime_us,
    input  [15:0] MipiRx_VidioRxHBlankTime_us,
    input  [5:0] MipiRx_StaRxDataType,
    input  [3:0] MipiRx_StateRxVCActive,
    input  [0:0] MipiRx_StateRxChannelActive,
    input  [17:0] MipiRx_StateRxError,
    input  [0:0] MipiRx_StateRxReslutionChange,
    input  [0:0] MipiRx_StateRxStateChange,
    input  [7:0] MipiRx_StateRxDataRight,
    output [2:0] MipiRx_ConfigRxLanesNumber,
    output [0:0] MipiRx_ControlRxDPHYReset,
    output [0:0] MipiRx_ControlRxCSIReset,
    output [0:0] MipiRx_ControlRxErrorClear,
    output [3:0] MipiRx_ConfigRxVCEnable,
    input  LA_MipiRx_clk,
    input  [3:0] LA_MipiRx_MipiRxVSync,
    input  [3:0] LA_MipiRx_MipiRxHSync,
    input  [0:0] LA_MipiRx_MipiRxDValid,
    input  [7:0] LA_MipiRx_MipiRxData,
    input  [0:0] LA_MipiRx_MipiRxError,
    input  [1:0] LA_MipiRx_MipiRxVC,
    input  [5:0] LA_MipiRx_MipiRxDataType
);
    ...
    wire MipiTx_module_select;
    wire MipiTx_module_inhibit;
    wire MipiTx_module_tdo;

    wire MipiRx_module_select;
    wire MipiRx_module_inhibit;
    wire MipiRx_module_tdo;

    wire LA_MipiRx_module_select;
    wire LA_MipiRx_module_inhibit;
    wire LA_MipiRx_module_tdo;

    assign MipiTx_module_select     = edb_module_selects[0];
    assign edb_module_inhibit[0]    = MipiTx_module_inhibit;
    assign edb_module_tdo[0]        = MipiTx_module_tdo;
    assign MipiRx_module_select     = edb_module_selects[1];
    assign edb_module_inhibit[1]    = MipiRx_module_inhibit;
    assign edb_module_tdo[1]        = MipiRx_module_tdo;
    assign LA_MipiRx_module_select      = edb_module_selects[2];
    assign edb_module_inhibit[2]    = LA_MipiRx_module_inhibit;
    assign edb_module_tdo[2]        = LA_MipiRx_module_tdo;
    ...
    edb_vio_top #(
        ...
        .PROBE_OUT10_WIDTH      ( 1 ),
        .PROBE_OUT11_WIDTH      ( 1 ),
        .PROBE_OUT0_INIT_VAL    ( 'h3c ),
        .PROBE_OUT1_INIT_VAL    ( 'h438 ),
        .PROBE_OUT2_INIT_VAL    ( 'h780 ),
        .PROBE_OUT3_INIT_VAL    ( 'h1 ),
        .PROBE_OUT4_INIT_VAL    ( 'h1 ),
        .PROBE_OUT5_INIT_VAL    ( 'h1 ),
        .PROBE_OUT6_INIT_VAL    ( 'h2a ),
        .PROBE_OUT7_INIT_VAL    ( 'h0 ),
        .PROBE_OUT8_INIT_VAL    ( 'h1 ),
        ...
        .edb_module_select  ( MipiTx_module_select  ),
        .edb_module_inhibit ( MipiTx_module_inhibit ),
        .edb_module_tdo     ( MipiTx_module_tdo ),
        .clk                ( MipiTx_clk ),
        .probe_in0          ( MipiTx_ParamTxVertSyncLength_Cycle ),
        .probe_in1          ( MipiTx_ParamTxHoriSyncLength_Cycle ),
        .probe_in2          ( MipiTx_paramTxDataValidLength_Cycle ),
        .probe_in3          ( MipiTx_paramTxVertBlankLength_Cycle ),
        .probe_in4          ( MipiTx_paramTxHoriBlankLength_Cycle ),
        .probe_in5          ( MipiTx_RealTxHoriPixelNumber ),
        .probe_in6          ( 1'b0 ),
        .probe_in7          ( 1'b0 ),
        .probe_in8          ( 1'b0 ),
        .probe_in9          ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( MipiTx_ConfigTxFrameRate ),
        .probe_out1         ( MipiTx_ConfigTxVertPixelNumber ),
        .probe_out2         ( MipiTx_ConfigTxHoriPixelNumber ),
        .probe_out3         ( MipiTx_ConfigTxVBlankTime_us ),
        .probe_out4         ( MipiTx_ConfigTxHBlankTime_us ),
        .probe_out5         ( MipiTx_configTxLanesNumber ),
        .probe_out6         ( MipiTx_ConfigPixelDataType ),
        .probe_out7         ( MipiTx_ConfigTxVCEnable ),
        .probe_out8         ( MipiTx_ControlTxDPHYReset ),
        .probe_out9         ( MipiTx_ControlTxCSIReset ),
        .probe_out10            ( MipiTx_ControlTxDisable ),
        .probe_out11            ( MipiTx_ConfigTxFramerMode ),
        .probe_out12            (  ),
        .probe_out13            (  ),
        .probe_out14            (  ),
        .probe_out15            (  ),
    ...
    edb_vio_top #(
        ...
        .bscan_UPDATE       ( bscan_UPDATE  ),
        .edb_user_dr        ( edb_user_dr ),
        .edb_module_select  ( MipiRx_module_select  ),
        .edb_module_inhibit ( MipiRx_module_inhibit ),
        .edb_module_tdo     ( MipiRx_module_tdo ),
        .clk                ( MipiRx_clk ),
        .probe_in0          ( MipiRx_VidioRxFrameRate ),
        .probe_in1          ( MipiRx_VidioRxVertPixeNumber ),
        .probe_in2          ( MipiRx_VidioRxHoriPixeNumber ),
        .probe_in3          ( MipiRx_VidioRxVBlankTime_us ),
        .probe_in4          ( MipiRx_VidioRxHBlankTime_us ),
        .probe_in5          ( MipiRx_StaRxDataType ),
        .probe_in6          ( MipiRx_StateRxVCActive ),
        .probe_in7          ( MipiRx_StateRxChannelActive ),
        .probe_in8          ( MipiRx_StateRxError ),
        .probe_in9          ( MipiRx_StateRxReslutionChange ),
        .probe_in10         ( MipiRx_StateRxStateChange ),
        .probe_in11         ( MipiRx_StateRxDataRight ),
        .probe_in12         ( 1'b0 ),
        .probe_in13         ( 1'b0 ),
        .probe_in14         ( 1'b0 ),
        .probe_in15         ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( MipiRx_ConfigRxLanesNumber ),
        .probe_out1         ( MipiRx_ControlRxDPHYReset ),
        .probe_out2         ( MipiRx_ControlRxCSIReset ),
        .probe_out3         ( MipiRx_ControlRxErrorClear ),
        .probe_out4         ( MipiRx_ConfigRxVCEnable ),
        .probe_out5         (  ),
        .probe_out6         (  ),
        .probe_out7         (  ),
        .probe_out8         (  ),
    ...
    edb_la_top #(
        ...
        .bscan_UPDATE           ( bscan_UPDATE  ),
        .edb_user_dr            ( edb_user_dr ),
        .edb_module_select      ( LA_MipiRx_module_select  ),
        .edb_module_inhibit     ( LA_MipiRx_module_inhibit ),
        .edb_module_tdo         ( LA_MipiRx_module_tdo ),
        .clk                    ( LA_MipiRx_clk ),
        .trig_in                ( 1'b0 ),
        .trig_in_ack            (  ),
        .trig_out               (  ),
        .trig_out_ack           ( 1'b0 ),
        .probe0                 ( LA_MipiRx_MipiRxVSync ),
        .probe1                 ( LA_MipiRx_MipiRxHSync ),
        .probe2                 ( LA_MipiRx_MipiRxDValid ),
        .probe3                 ( LA_MipiRx_MipiRxData ),
        .probe4                 ( LA_MipiRx_MipiRxError ),
        .probe5                 ( LA_MipiRx_MipiRxVC ),
        .probe6                 ( LA_MipiRx_MipiRxDataType )
    );
